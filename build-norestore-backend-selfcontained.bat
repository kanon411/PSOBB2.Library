dotnet publish src/Server/PSOBB.Service.Authentication/PSOBB.Service.Authentication.csproj -c DEBUG_LOCAL --self-contained -r win10-x64
dotnet publish src/Server/PSOBB.Service.ServiceDiscovery/PSOBB.Service.ServiceDiscovery.csproj -c DEBUG_LOCAL --self-contained -r win10-x64
dotnet publish src/Server/PSOBB.Service.ServerSelection/PSOBB.Service.ServerSelection.csproj -c DEBUG_LOCAL --self-contained -r win10-x64
dotnet publish src/Server/PSOBB.Service.GameServer/PSOBB.Service.GameServer.csproj -c DEBUG_LOCAL --self-contained -r win10-x64
dotnet publish src/Server/PSOBB.Service.ContentServer/PSOBB.Service.ContentServer.csproj -c DEBUG_LOCAL --self-contained -r win10-x64
dotnet publish src/Server/PSOBB.Service.Social/PSOBB.Service.Social.csproj -c DEBUG_LOCAL --self-contained -r win10-x64
