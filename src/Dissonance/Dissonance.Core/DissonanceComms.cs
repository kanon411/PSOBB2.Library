...
namespace Dissonance
{
		...
		: MonoBehaviour, IAccessTokenCollection, IVolumeProvider, IVoiceActivisionSubscribable
	{
		...
		{
			_playbackPool = new PlaybackPool((IVolumeProvider)this);
			_playerTrackers = new PlayerTrackerManager(_players);
			_capture = new CapturePipelineManager(_codecSettingsLoader, Players);
		}
		...
		[UsedImplicitly] private void Update()
		{
			...
			//TODO: Used to duck here, what should we do now?
			CustomProjectDissonanceAsserts.AssertVoiceDuckingIsntNeeded();
		...
		{
			get { return _isDeafened ? 0 : RemoteVoiceVolume; }
		}
		#endregion
	}
}
