...
namespace Guardians
{
	...
	/// </summary>
	public static class VoicePayloadMetadataMarker
	{
		...
		static VoicePayloadMetadataMarker()
		{
			PayloadTypes = typeof(VoiceDataChangeRaiseRequestPayload)
				.Assembly
				.GetExportedTypes()
			...
			AllProtobufModels = typeof(VoiceDataChangeRaiseRequestPayload)
				.Assembly
				.GetTypes()
